 ...
 * @date 2022-09-04
 */
public class CaseLaws extends BaseEntity
{
    private static final long serialVersionUID = 1L;

    private CaseDecreases caseDecrease;

    private CaseCaseTypes caseCaseType;

    private Clients client;

    private HrEmps hrEmp;

    private String caseSubtime2;
    private String collectionTime2;

    private String payment; // 款项
    ...
    public HrEmps getHrEmp() {
        return hrEmp;
    }

    public void setHrEmp(HrEmps hrEmp) {
        this.hrEmp = hrEmp;
    }

    public String getCaseSubtime2() {
        return caseSubtime2;
    }

    public void setCaseSubtime2(String caseSubtime2) {
        this.caseSubtime2 = caseSubtime2;
    }
    ...
    public CaseDecreases getCaseDecrease() {
        return caseDecrease;
    }

    public void setCaseDecrease(CaseDecreases caseDecrease) {
        this.caseDecrease = caseDecrease;
    }

    public CaseCaseTypes getCaseCaseType() {
        return caseCaseType;
    }

    public void setCaseCaseType(CaseCaseTypes caseCaseType) {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("caseSubtime2",getCaseSubtime2())
            .append("collectionTime2",getCollectionTime2())
