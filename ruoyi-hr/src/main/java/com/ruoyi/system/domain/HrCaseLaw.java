 ...
 * @date 2022-10-11
 */
public class HrCaseLaw extends BaseEntity
{
    ...
    /** 诉讼标的 */
    @Excel(name = "诉讼标的")
    private Integer caseLawsuitobj;
    ...
    /** 代理费 */
    @Excel(name = "代理费")
    private String caseAgencyfee;

    /** 杂费 */
    @Excel(name = "杂费")
    private String caseProxysal;
    ...
    /** 未付金额 */
    @Excel(name = "未付金额")
    private String caseUnpaidsal;

    /** 已开票金额 */
    @Excel(name = "已开票金额")
    private String caseInvoiced;

    /** 未开票金额 */
    @Excel(name = "未开票金额")
    private String caseNotinvoiced;
    ...
    public void setCaseLawsuitobj(Integer caseLawsuitobj) 
    {
        this.caseLawsuitobj = caseLawsuitobj;
    }

    public Integer getCaseLawsuitobj() 
    {
    ...
    public void setCaseSubsidysal(String caseSubsidysal) 
    {
        this.caseSubsidysal = caseSubsidysal;
    }

    public String getCaseSubsidysal() 
    {
    ...
    public void setCaseAgencyfee(String caseAgencyfee) 
    {
        this.caseAgencyfee = caseAgencyfee;
    }

    public String getCaseAgencyfee() 
    {
        return caseAgencyfee;
    }
    public void setCaseProxysal(String caseProxysal) 
    {
        this.caseProxysal = caseProxysal;
    }

    public String getCaseProxysal() 
    {
        return caseProxysal;
    }
    ...
    public void setCaseUnpaidsal(String caseUnpaidsal) 
    {
        this.caseUnpaidsal = caseUnpaidsal;
    }

    public String getCaseUnpaidsal() 
    {
        return caseUnpaidsal;
    }
    public void setCaseInvoiced(String caseInvoiced) 
    {
        this.caseInvoiced = caseInvoiced;
    }

    public String getCaseInvoiced() 
    {
        return caseInvoiced;
    }
    public void setCaseNotinvoiced(String caseNotinvoiced) 
    {
        this.caseNotinvoiced = caseNotinvoiced;
    }

    public String getCaseNotinvoiced() 
    {
    ...
    public void setCaseFxmoney(Integer caseFxmoney) 
    {
        this.caseFxmoney = caseFxmoney;
    }

    public Integer getCaseFxmoney() 
    {
        return caseFxmoney;
    }
