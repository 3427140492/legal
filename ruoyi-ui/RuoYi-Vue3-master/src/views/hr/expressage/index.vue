<template>
    <el-card>
      <el-tabs v-model="activeName" type="border-card">
        <el-tab-pane label="收件管理" name="sjgl" >
          <sjgl-info-form ref="sjglInfo" :info="info" />
        </el-tab-pane>
        <el-tab-pane label="发件管理" name="fjgl">
         <fjgl-info-form ref="fjglInfo" :info="info" />
        </el-tab-pane>
      </el-tabs>
    </el-card>
  </template>
  ...
  import sjglInfoForm from "./sjgl.vue";
  import fjglInfoForm from "./fjgl.vue";
