        ...
        <el-table-column label="承办律师" align="center" prop="caseAttorney" width="220" resizable show-overflow-tooltip/>
         ...
         <el-table-column label="操作" align="center" fixed="right">
               <template #default="scope">
                  ...
                  <template #dropdown>
                     <el-dropdown-menu>
                           <el-dropdown-item @click="dialog5Fun(scope.row.id)">修改</el-dropdown-item>
                           <el-dropdown-item @click="editCase(scope.row.id)">删除</el-dropdown-item>
                     </el-dropdown-menu>
                  </template>
                  </el-dropdown>
               </template>
...
/* 打开dialog5 */
function dialog5Fun(clid){
   propsEmitDialog5.value.propsEmitRef(clid);
}

/* 删除案件 */
function editCase(id){
   queryParams.caseSubmitter = '';
   queryParams.id = id;
   queryParams.caseRecycle = 'N';
