...
public class CaseLaw extends BaseEntity
{
    ...
    /** 案件类型信息 */
    private List<CaseCaseType> caseCaseTypeList;
    ...
    public List<CaseCaseType> getCaseCaseTypeList()
    {
        return caseCaseTypeList;
    }

    public void setCaseCaseTypeList(List<CaseCaseType> caseCaseTypeList)
    {
        this.caseCaseTypeList = caseCaseTypeList;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("caseCaseTypeList", getCaseCaseTypeList())
            .toString();
    }
}
